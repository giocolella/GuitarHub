...
<head>
  ...
  <script src="./scripts/displayProductJS.js" type="text/javascript"></script>
...
<section>
        <div class="search-bar">
           <form id="searchForm">
    			...
    			<button type="submit" id="searchBtn1"><img src="../images/search.png" alt=""></button>
  		   </form>
        </div>
</section>
  <section>
        ...
        <div class="product-list" id="productList">
            ...
            <div class="product-item">
                ...
                <div class="price">
                    ...
                    <a href="#" class="icon"><i class="fa-solid fa-bag-shopping"></i></a>
                </div>
            </div>
	...
	$("#searchForm").submit(function(event) {
	    ...
	    $.get("/productSearch", { q: query }, function(data) {
