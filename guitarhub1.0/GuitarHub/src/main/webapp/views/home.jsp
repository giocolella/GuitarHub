...
<body>
    ...
    <section id="hero">
      ...
      <p>- David Bowie</p>
      <img src="../images/homeback.jpg" class="backimg">
    </section>
   ...
   <div class="grid-container">
    <div class="grid-item">
      <img src="../images/categories/6corde.jpg" alt="Chitarra a 6 corde">
      <p>Chitarra a 6 corde</p>
    </div>
    <div class="grid-item">
      <img src="../images/categories/7corde.jpg" alt="Chitarra a 7 corde">
      <p>Chitarra a 7 corde</p>
    </div>
    <div class="grid-item">
      <img src="../images/categories/8corde.jpg" alt="Chitarra a 8 corde">
      <p>Chitarra a 8 corde</p>
    </div>
    <div class="grid-item">
      <img src="../images/categories/12corde.jpg" alt="Chitarra a 12 corde">
      <p>Chitarra a 12 corde</p>
    </div>
    <div class="grid-item">
      <img src="../images/categories/semiacustica.jpg" alt="Chitarra semiacustica">
      <p>Chitarra semiacustica</p>
    </div>
    <div class="grid-item">
      <img src="../images/categories/3quarti.jpg" alt="Chitarra a 3/4">
      <p>Chitarra a 3/4</p>
    </div>
    <div class="grid-item">
      <img src="../images/categories/signature.jpg" alt="Chitarre signature">
