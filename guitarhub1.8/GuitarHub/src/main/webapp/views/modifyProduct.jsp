        ...
        <form action="javascript:void(0);">
            <div class="input-group">
                <div class="input-field">
                    <input type="text" id="productName" onchange="validateModifyProductNameForm(event)" placeholder="Nome">
                </div>
                <div class="input-field">
                    <input type="number" id="productQuantity" min="0" placeholder="Quantità">
                </div>
                <div class="input-field">
                    <input type="text" id="productDescription" onchange="validateModifyProductDescriptionForm(event)" placeholder="Descrizione">
                </div>
                <div class="input-field">
                    <input type="text" id="productPrice" min="0" onchange="validateModifyProductPriceForm(event)" placeholder="Prezzo">
                </div>
                <div class="input-field">
                    <input type="number" id="productDiscount" min="0" max="100" placeholder="Sconto">
                </div>
                <div class="input-field">
                    <input type="text" id="productBrand" onchange="validateModifyProductBrandForm(event)" placeholder="Marca">
                </div>
                <div class="input-field">
