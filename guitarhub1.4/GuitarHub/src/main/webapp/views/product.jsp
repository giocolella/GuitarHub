...
<section id="prodetails" class="section-p1">
    ...
    <div class="single-pro-details">
        <h4 id="productName">Nome Prodotto</h6>
...
<section class="review-form">
    ...
    <form class="reviewForm">
      <input type="text" id="review-title" name="review-title" placeholder="Titolo" required>
      <input type="number" id="review-score" name="review-score" min="1" max="5" placeholder="Punteggio" required>
      <textarea id="review-description" name="review-description" cols="30" rows="10" placeholder="Descrizione" required></textarea>
