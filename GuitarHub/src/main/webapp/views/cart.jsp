...
<section id="cart-add" class="section-p1">
    ...
    <div class="subtotal">
       ...
       <% if (session.getAttribute("User") != null && session.getAttribute("cart") != null) { 
	   			...
	   			<% } else { %>
  					<button class="normal"><a href="#" id="checkoutButton2">Procedi al checkout</a></button>
	   			<% } %>
	   <% } else { %>
			<button class="normal"><a href="${pageContext.request.contextPath}/views/login.jsp" id="checkoutButton3">Procedi al checkout</a></button>
  		<% } %>
    </div>
</section>
