...
<section id="prodetails" class="section-p1">
    <div class="single-pro-image">
        <img id="MainImage" src="${sessionScope.productSearched.imagePath}i1.jpg" alt="" width="100%">

        <div class="small-img-group">
            <div class="small-img-col">
                <img src="${sessionScope.productSearched.imagePath}i1.jpg" alt="" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="${sessionScope.productSearched.imagePath}i2.jpg" alt="" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="${sessionScope.productSearched.imagePath}i3.jpg" alt="" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="${sessionScope.productSearched.imagePath}i4.jpg" alt="" width="100%" class="small-img">
            </div>
        </div>
    </div>
