...
<div class="container">
    <div class="form-box">
        ...
        <form action="${pageContext.request.contextPath}/ModifyProduct" method="post">
             <div class="input-group">
                <div class="input-field">
                    <input type="text" id="productName" name="productName"onchange="validateModifyProductNameForm(event)" placeholder="Nome">
                </div>
                <div class="input-field">
                    <input type="text" id="imagePath" name="imagePath" onchange="validateModifyImagePathForm(event)" placeholder="Path assoluto immagine">
                </div>
                <div class="input-field">
                ...
                <div class="input-field">
                    <input type="text" id="shortDescription" name="shortDescription"onchange="validateModifyProductShortDescriptionForm(event)" placeholder="Descrizione breve">
                </div>
                <div class="input-field">
...
$(document).ready(function() {
	  ...
	  if (/^\d+$/.test(productId) && parseInt(productId) > 0) {
	    $.get("${pageContext.request.contextPath}/GetProduct", { productId: productId })
	      .done(function(response) {
	        populateProductFields(response);
	      })
	      .fail(function(error) {
	      });
	  } else {
