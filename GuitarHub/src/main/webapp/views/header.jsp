			...
			<ul id="navbar">
				...
				<% Boolean isAdmin = (Boolean) session.getAttribute("isAdmin");
   				...
   				<% } else { %>  
  					 ...
  					 <% } %>
				<li><a href="#" id="imgLogin"><img id="userProfilePicture" src="${pageContext.request.contextPath}/images/profile/user2.jpg" alt="" class="user-pic" onclick="toggleMenu()"></a></li>
			...
			<div class="sub-menu-wrap" id="subMenu">
				<div class="sub-menu">
					<div class="user-info">
						...
						<h3 id="userName">Il tuo profilo</h3>
					</div>
					<hr>

					<a href="${pageContext.request.contextPath}/views/orders.jsp" class="sub-menu-link"> 
						<img src="${pageContext.request.contextPath}/images/profile/setting.png" id="userOrders" alt="">
						<p>I tuoi ordini</p> <span>></span>
					</a>
					<a href="${pageContext.request.contextPath}/Logout" class="sub-menu-link"> 
						<img src="${pageContext.request.contextPath}/images/profile/logout.png" id="userLogout" alt="">
					...
					<a href="${pageContext.request.contextPath}/DeleteAccount" class="sub-menu-link" style="color:red;" id="deleteAccount"> 
						<img src="${pageContext.request.contextPath}/images/profile/user2.jpg" id="userPicture" alt="">
