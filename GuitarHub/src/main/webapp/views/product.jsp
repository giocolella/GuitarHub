...
<head>
  ...
  <script src="${pageContext.request.contextPath}/views/scripts/reviewValidator.js"></script>
    <script src="${pageContext.request.contextPath}/views/scripts/displayReviewsJS.js"></script>
...
<section id="prodetails" class="section-p1">
    <div class="single-pro-image">
        <img id="MainImage" src="${sessionScope.productSearched.imagePath}i1.jpg" alt="no image">

        <div class="small-img-group">
            <div class="small-img-col">
                <img src="${sessionScope.productSearched.imagePath}i1.jpg" alt="no image" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="${sessionScope.productSearched.imagePath}i2.jpg" alt="no image" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="${sessionScope.productSearched.imagePath}i3.jpg" alt="no image" width="100%" class="small-img">
            </div>
            <div class="small-img-col">
                <img src="${sessionScope.productSearched.imagePath}i4.jpg" alt="no image" width="100%" class="small-img">
            </div>
        </div>
    </div>
...
<script>
  ...
  $(document).ready(function() {
	  ...
	  if (productId !== null && productId !== "") {
	    $.get("${pageContext.request.contextPath}/ReviewsPopulator", { productId: productId })
	      .done(function(response) {
	        if (response === "Nessuna recensione") {
	          $("#reviewMessage").text("Nessuna recensione");
	          $("#reviewMessage").css("font-weight", "bold");
	        } else {
