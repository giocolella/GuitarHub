function validateCheckoutForm(event) {
        ...
        var lastNameAddress = document.getElementById("cognomeInd");
        ...
        if (firstName.trim() === "" || lastName.trim() === "" || lastNameAddress.trim() === "" || address.trim() === "" || !isChecked || birthday.trim() === "" || city.trim() === "" || province.trim() === "" || postalCode.trim() === "" || street.trim() === "" 
        || telefonoInput.trim() === "" || cardNumber.trim() === "" || expDate.trim() === "" || civicNumber.trim() === "" || cvv.trim() === "") {
