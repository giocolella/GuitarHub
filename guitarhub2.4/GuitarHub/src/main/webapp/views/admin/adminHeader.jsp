...
<body>
	<section id="header">
		...
		<nav>
			<ul id="navbar">
				<li><a href="${pageContext.request.contextPath}/views/adminSearch.jsp">Ricerca Prodotti</a></li>
				<li><a href="${pageContext.request.contextPath}/views/adminOrders.jsp">Ricerca Ordini</a></li>
