...
<section id="form-details">
    <form action="javascript:void(0);">
        ...
        <input type="text" id="oggettoInput" placeholder="Oggetto">
        <textarea name="" id="testoInput" cols="30" rows="10" placeholder="Il tuo messaggio"></textarea>
        <button onclick="validateContactsForm()">Submit</button>
    </form>
</section>
